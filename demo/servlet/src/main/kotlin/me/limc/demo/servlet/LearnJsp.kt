...
class StudentMgrServlet : HttpServlet() {
  ...
  companion object {
    private const val RAND_ID_MAX = 99_999
    private const val RAND_STR_LEN = 8
    private const val RAND_GRADE_MIN = 60
    private const val RAND_GRADE_MAX = 100
    private val stuCnt = 100.toUInt()
  }
}
